...
/*      throw new Exception("Problem reading default properties: "
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 6681 $");
  }
  ...
  public static void main(String[] ops) {
	...
	System.out.println(partitionedOptions[i]);
      ...
      System.out.println("Original array with NaN (doubles): ");
        for (double aDoublesWithNaN : doublesWithNaN) {
            System.out.print(aDoublesWithNaN + " ");
        }
      System.out.println();
      System.out.println("Original array (doubles): ");
        for (double aDouble2 : doubles) {
            System.out.print(aDouble2 + " ");
        }
      System.out.println();
